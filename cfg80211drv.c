...
unsigned char CFG80211DRV_OpsSetChannel(
	void					*pAdOrg,
	void					*pData)
{
...
unsigned char CFG80211DRV_OpsChgVirtualInf(
	void					*pAdOrg,
	void					*pFlgFilter,
	UINT8						IfType)
{
...
unsigned char CFG80211DRV_OpsScan(
	void					*pAdOrg)
{
	PRTMP_ADAPTER pAd = (PRTMP_ADAPTER)pAdOrg;
...
unsigned char CFG80211DRV_OpsJoinIbss(
	void					*pAdOrg,
	void					*pData)
{
#ifdef CONFIG_STA_SUPPORT
...
unsigned char CFG80211DRV_OpsLeave(
	void					*pAdOrg)
{
#ifdef CONFIG_STA_SUPPORT
	PRTMP_ADAPTER pAd = (PRTMP_ADAPTER)pAdOrg;
...
unsigned char CFG80211DRV_StaGet(
	void					*pAdOrg,
	void					*pData)
{
	PRTMP_ADAPTER pAd = (PRTMP_ADAPTER)pAdOrg;
...
unsigned char CFG80211DRV_KeyAdd(
	void					*pAdOrg,
	void					*pData)
{
#ifdef CONFIG_STA_SUPPORT
...
unsigned char CFG80211DRV_Connect(
	void					*pAdOrg,
	void					*pData)
{
#ifdef CONFIG_STA_SUPPORT
...
========================================================================
*/
unsigned char CFG80211_SupBandReInit(
void					*pAdCB)
{
	PRTMP_ADAPTER pAd = (PRTMP_ADAPTER)pAdCB;
