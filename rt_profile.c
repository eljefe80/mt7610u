...
unsigned char L2PAD, PHYMODE, BW, ShortGI, MCS, AMPDU, STBC, RSSI1;
unsigned char BssMonitorFlag11n, Channel, CentralChannel;
unsigned char*pData, *pDevName;
	...
	pDevName = (unsigned char *)RtmpOsGetNetDevName(pAd->net_dev);
...
#ifdef WDS_SUPPORT
voidAP_WDS_KeyNameMakeUp(
STRING						*pKey,
unsigned int					KeyMaxSize,
INT							KeyId)
{
