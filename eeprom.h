...
int eFuseRead(struct _RTMP_ADAPTER *pAd, unsigned short Offset, unsigned short *pData, unsigned short len);
int eFuseWrite(struct _RTMP_ADAPTER *pAd, unsigned short Offset, unsigned short *pData, unsigned short len);
